...
var _jinjor$elm_diff$Diff$makeChangesHelp = F4(
	function (getA, getB, _p1, path) {
		var _p2 = _p1;
		var _p7 = _p2._1;
		var _p6 = _p2._0;
		var _p3 = path;
...
var _jinjor$elm_diff$Diff$makeChanges = F3(
	function (getA, getB, path) {
		...
		if (_p8.ctor === '[]') {
			...
			return A4(_jinjor$elm_diff$Diff$makeChangesHelp, getA, getB, _p8._0, _p8._1);
		}
	});
		...
		while (true) {
			var ks = (_elm_lang$core$Native_Utils.cmp(delta, 0) > 0) ? A2(
				...
				_elm_lang$core$List$reverse(
					_elm_lang$core$Native_List.range(delta + 1, delta + p)),
				_elm_lang$core$Native_List.range(0 - p, delta)) : A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$List$reverse(
					_elm_lang$core$Native_List.range(delta + 1, p)),
				_elm_lang$core$Native_List.range((0 - p) + delta, delta));
...
var _jinjor$elm_diff$Diff$diff = F2(
	function (a, b) {
		...
		return _elm_lang$core$List$reverse(
			A3(_jinjor$elm_diff$Diff$makeChanges, getAOrCrash, getBOrCrash, path));
	});
...
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$stopWatchingButtonHover = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'opacity', _1: '0.5'}
	]);
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$stopWatchingButton = _elm_lang$core$Native_List.fromArray(
	[
...
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelDetailTreeEach = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin-bottom', _1: '20px'}
	]);
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelFilterInput = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'block'},
		{ctor: '_Tuple2', _0: 'width', _1: '100%'},
		{ctor: '_Tuple2', _0: 'padding', _1: '5px 10px'},
		{ctor: '_Tuple2', _0: 'background-color', _1: 'rgba(0,0,0,0.2)'},
		{ctor: '_Tuple2', _0: 'margin-bottom', _1: '10px'},
		{ctor: '_Tuple2', _0: 'border', _1: 'none'},
		{ctor: '_Tuple2', _0: 'box-shadow', _1: '2px 1px 7px 0px rgba(0,0,0,0.4) inset'},
...
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$textLinkHover = _elm_lang$core$Native_List.fromArray(
	[
...
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelDetailTreeEachId = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'color', _1: _jinjor$elm_time_travel$TimeTravel_Internal_Styles$darkTextColor},
		{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'}
	]);
...
var _jinjor$elm_time_travel$TimeTravel_Internal_Styles$watchViewHeader = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'color', _1: _jinjor$elm_time_travel$TimeTravel_Internal_Styles$darkTextColor}
	]);
...
var _jinjor$elm_time_travel$TimeTravel_Internal_View$modelDetailTreeEachId = function (id) {
	var watchLink = A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelDetailTreeEachIdWatch),
				_elm_lang$html$Html_Events$onClick(
				_jinjor$elm_time_travel$TimeTravel_Internal_Model$SelectModelFilterWatch(id))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('watch')
			]));
	var filterLink = A4(
		_jinjor$elm_inline_hover$InlineHover$hover,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelDetailTreeEachId),
				_elm_lang$html$Html_Events$onClick(
...
var _jinjor$elm_time_travel$TimeTravel_Internal_View$modelDetailTreeEach = F3(
	function (expandedTree, maybeId, ast) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelDetailTreeEach)
				]),
			A2(
				_elm_lang$core$List_ops['::'],
				idView,
...
var _jinjor$elm_time_travel$TimeTravel_Internal_View$watchView = function (model) {
	...
	if ((((_p12.ctor === '_Tuple2') && (_p12._0.ctor === 'Just')) && (_p12._1.ctor === 'Just')) && (_p12._1._0.ctor === 'Ok')) {
		...
		var stopWatchingButton = A4(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$stopWatchingButton),
					_elm_lang$html$Html_Events$onClick(_jinjor$elm_time_travel$TimeTravel_Internal_Model$StopWatching)
				]),
			_elm_lang$core$Native_List.fromArray(
				[_jinjor$elm_time_travel$TimeTravel_Internal_Icons$stopWatching]));
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$watchView)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$watchViewHeader)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
...
var _jinjor$elm_time_travel$TimeTravel_Internal_View$modelFilterInput = function (modelFilter) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_jinjor$elm_time_travel$TimeTravel_Internal_Styles$modelFilterInput),
				_elm_lang$html$Html_Attributes$placeholder('Filter by property'),
				_elm_lang$html$Html_Attributes$value(modelFilter),
				_elm_lang$html$Html_Events$onInput(_jinjor$elm_time_travel$TimeTravel_Internal_Model$InputModelFilter)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
	...
	function (fixedToLeft, modelFilter, expandedTree, lazyModelAst, userModel) {
		...
		if ((_p15.ctor === 'Just') && (_p15._0.ctor === 'Ok')) {
			...
			var filteredAst = function () {
				if (A2(_elm_lang$core$String$startsWith, '@', modelFilter)) {
					...
					if (_p16.ctor === 'Just') {
						return _elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: modelFilter, _1: _p16._0}
							]);
					} else {
						return _elm_lang$core$Native_List.fromArray(
							[]);
			...
			return A2(
				...
				A2(_elm_lang$core$List_ops['::'], filterInput, trees));
		} else {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
		...
		var body = function () {
			if (model.showModelDetail) {
				...
				if (_p24.ctor === 'Just') {
					...
					return A2(
						_elm_lang$core$List_ops['::'],
						A5(_jinjor$elm_time_travel$TimeTravel_Internal_View$modelDetailView, model.fixedToLeft, model.modelFilter, model.expandedTree, _p25.lazyModelAst, _p25.model),
						_elm_lang$core$Native_List.fromArray(
							[]));
				} else {
					return _elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$checked(_p27._1),
								_elm_lang$html$Html_Events$onClick(
	...
	function (visible, filterOptions) {
		return A2(
			...
			A2(
				...
				A2(_elm_lang$core$List$sortBy, _elm_lang$core$Basics$fst, filterOptions)));
	});
...
var _jinjor$elm_time_travel$TimeTravel_Html_App$OptionsWithFlags = F4(
	function (a, b, c, d) {
		return {init: a, view: b, update: c, subscriptions: d};
	});
var _jinjor$elm_time_travel$TimeTravel_Html_App$UserMsg = function (a) {
	return {ctor: 'UserMsg', _0: a};
};
var _jinjor$elm_time_travel$TimeTravel_Html_App$DebuggerMsg = function (a) {
	return {ctor: 'DebuggerMsg', _0: a};
};
var _jinjor$elm_time_travel$TimeTravel_Html_App$wrap = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
			...
			return _elm_lang$core$Platform_Sub$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						function (c) {
							return _jinjor$elm_time_travel$TimeTravel_Html_App$UserMsg(
								{ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: c});
						},
						_p3.subscriptions(item.model)),
						_p2.incomingMsg(
						function (_p4) {
							return _jinjor$elm_time_travel$TimeTravel_Html_App$DebuggerMsg(
		...
		var view$ = function (model) {
			return A4(
				...
				_jinjor$elm_time_travel$TimeTravel_Html_App$DebuggerMsg,
				_p3.view,
				model);
		};
		var update$ = F2(
				...
				if (_p5.ctor === 'UserMsg') {
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								c1,
								A2(_elm_lang$core$Platform_Cmd$map, _jinjor$elm_time_travel$TimeTravel_Html_App$DebuggerMsg, c2)
							]));
				} else {
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$core$Platform_Cmd$map, _jinjor$elm_time_travel$TimeTravel_Html_App$DebuggerMsg, c)
							]));
				}
			});
...
var _jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlagsWithOptions = F2(
	function (options, stuff) {
		return _elm_lang$html$Html_App$programWithFlags(
			A2(_jinjor$elm_time_travel$TimeTravel_Html_App$wrap, options, stuff));
	});
var _jinjor$elm_time_travel$TimeTravel_Html_App$programWithOptions = F2(
	function (options, _p13) {
		var _p14 = _p13;
		return A2(
			_jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlagsWithOptions,
			options,
			{
...
var _jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlags = function (stuff) {
	return A2(
		_jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlagsWithOptions,
		{
...
var _jinjor$elm_time_travel$TimeTravel_Html_App$beginnerProgram = function (_p15) {
	var _p16 = _p15;
	return _jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlags(
		{
...
var _jinjor$elm_time_travel$TimeTravel_Html_App$program = function (_p17) {
	var _p18 = _p17;
	return _jinjor$elm_time_travel$TimeTravel_Html_App$programWithFlags(
		{
...
var _user$project$Utils$uid = function (list) {
	return (_elm_lang$core$Native_Utils.cmp(
...
var _user$project$Requests$subOption = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$FormOption$SubOption,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'label', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'cost', _elm_lang$core$Json_Decode$float));
var _user$project$Requests$formOption = A7(
	_elm_lang$core$Json_Decode$object6,
	_user$project$FormOption$Model,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'orderIndex', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'description', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'subOptions',
		_elm_lang$core$Json_Decode$list(_user$project$Requests$subOption)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'cost', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'uid', _elm_lang$core$Json_Decode$int));
var _user$project$Requests$formOptions = _elm_lang$core$Json_Decode$list(_user$project$Requests$formOption);
var _user$project$Requests$getFormOptions = F2(
	function (failMsg, succeedMsg) {
		return A3(
			_elm_lang$core$Task$perform,
			failMsg,
			succeedMsg,
			A2(_evancz$elm_http$Http$get, _user$project$Requests$formOptions, '/estimates/api/formoptions'));
	});
